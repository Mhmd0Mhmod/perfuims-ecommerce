import BlockCustomerButton from "@/components/admin/customers/BlockCustomerButton";
...
async function page() {
  ...
  const adminCount = customers.content.filter((c: Customer) => c.role === "ADMIN").length;
  const userCount = customers.content.filter((c: Customer) => c.role === "USER").length;
                    ...
                    <TableRow key={customer.id} className="hover:bg-muted/50">
                      ...
                      <TableCell className="text-right">
                        ...
                        >
                          ...
                          {customer.role === "ADMIN" ? "مدير" : "مستخدم"}
                        </Badge>
                      </TableCell>
                      <TableCell className="text-right">
